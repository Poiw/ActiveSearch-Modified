...
python3 bin/split.py $DATA_DIR/list.txt $DATA_DIR/test.txt $DATA_DIR/train.txt $IMAGE_DIR/TestSplit.txt $IMAGE_DIR/TrainSplit.txt
...
# for d in `ls -1 $IMAGE_DIR | grep "seq"`
# do 
#     echo "$d"
#     python3 bin/sift.py $IMAGE_DIR/$d
# done
